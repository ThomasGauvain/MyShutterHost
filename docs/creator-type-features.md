# Creator Type Feature Specifications

> For each creator type: what makes them want to join, what their dashboard includes, what their website looks like, and how they earn money.
> Every type shares the core platform (social feed, booking, CRM, contracts, Stripe payments, analytics, chat, event calendar, Looking For board).
> This document covers what is **unique** to each type on top of that shared foundation.
> **Dedicated websites are paid-tier only (Creator Pro and above). Creator Free gets a social profile only.**
...
- **Unique Tools** — craft-specific features no other platform offers
- **Revenue Streams** — how they earn on the platform
- **CRM Pipeline** — their workflow-specific stages
- **Looking For** — what they post on the collaboration board
...
- AI culling queue (ranked photos awaiting approval)
- Print order manager (pending / in production / shipped)
- RAW file delivery vault
- Event QR card generator
- Preset & actions marketplace (publish and sell presets)
- Second shooter collaboration (co-deliver a gallery)
...
- `/about` — Bio, gear list, shooting style
- `/services` — Session packages + pricing
- `/store` — Print shop + digital downloads + preset marketplace
- `/booking` — Session booking calendar with deposit
- `/blog` — Journal / behind the scenes
- `/client-gallery` — Login-gated client delivery
...
- AI style trainer (learns their editing style, replicates it)
- Watermark manager (auto-apply on download/share)
- EXIF data toggle per gallery
- RAW file vault (separate secure storage)
- Photo culling swipe tool (keep / reject / maybe)
- Batch tagging and smart album builder
- Face indexing per event (guests find themselves by selfie)
- QR code / NFC event card
- Slideshow builder (Ken Burns, fade, music sync)
- Geographic tag map
- Second shooter gallery merging
...
- Preset / action store
- Tutorial PDF / workshop sales
- Tips and Stars from gallery visitors
- Pay-to-unlock high-res gallery

**CRM Pipeline**
`New Inquiry → Consultation → Proposal Sent → Deposit Paid → Shoot Day → Editing → Gallery Delivered → Print Fulfilled → Archived`

**Looking For**
Models, MUAs, Hair Stylists, Stylists, Second Shooters, Studio Rentals, Venues
...
- Music license tracker (log Musicbed / Artlist / sync licenses per project)
- Production credit builder (IMDb-style credits per project)
- Color grade reference library
- Shot list and storyboard uploader per project
- Video format delivery tracker (codec / resolution per client)
...
- `/about` — Bio, equipment, production credits
- `/services` — Production packages (wedding / commercial / music video / doc)
- `/booking` — Project inquiry + consultation booking
- `/client` — Login-gated client video delivery portal
...
- Storyboard PDF uploader per project
- Color grade reference sharing
- Production credit builder per project (role / name / links to their creator profile)
- Video format delivery manager (ProRes / H.264 / 4K / 1080p per client)
- RAW footage package sales
...
- Tutorial / BTS content sales
- Video template sales

**CRM Pipeline**
`Inquiry → Discovery Call → Proposal → Pre-production Meeting → Shoot Day(s) → Edit → Client Review → Revisions → Final Delivery → Invoice → Archived`

**Looking For**
Models, Actors, Sound Recordists, Drone Operators, Colorists, Second Camera Ops, Musicians (original scores)
...
- Look manager (commercial look vs editorial vs fitness look)
- Casting availability calendar (open / booked / hold dates)
- Agency / representation manager
- Travel availability map (cities/countries willing to travel to)
- Model release tracker (which photos have signed releases)
...
- `/editorial` `/commercial` `/fitness` — Look-specific galleries
- `/tearsheets` — Published work by brand / publication / year
- `/about` — Bio, market experience, travel availability
- `/rates` — Rate card by project type
- `/availability` — Casting calendar (public open dates)
...
- Tearsheet organizer (tag by brand, publication, photographer, year)
- Travel availability map (interactive cities/countries display)
- Model release manager (track signed releases per photo)
- Media kit PDF generator (auto-format press packet)
- Agency portal (agencies manage rosters and submit bookings)
- Go-see / casting appointment booking type
...
- Tips and Stars from fans
- Exclusive content subscriptions (optional)

**CRM Pipeline**
`Inquiry / Go-see → Hold → Booking Confirmed → Shoot Day → Delivered → Invoiced`

**Looking For**
Photographers, Videographers, MUAs, Hair Stylists, Stylists, Fashion Designers, Other Models (editorial group work)
...
- Audition tracker (what auditioned for, status, callback?)
- Audition sides storage (private, secure — scripts/sides)
- Self-tape submission tool (record, review, share from browser)
- Physical stats profile (height, weight, eye/hair color, ethnicity, age range)
- Special skills manager (languages, accents, instruments, sports, combat)
- Training and education chronological display
- Union credentials display (SAG-AFTRA, AEA, ACTRA, Equity)
...
- `/reel` — Demo reel with scene timestamps and descriptions
- `/about` — Bio, background, physical stats, special skills
- `/credits` — Full credits sortable by medium and year
...
- Audition sides PDF viewer (private, secure storage for scripts)
- Audition tracker (project / role / date / casting director / callback status)
- Physical stats profile (industry-standard casting breakdown format)
- Special skills tagger (dialects, languages, sports, instruments, stunts, combat)
- Union badge display (verified SAG-AFTRA, AEA, ACTRA, Equity)
...
**CRM Pipeline**
`Audition → Callback → Screen Test → Offer → Contract → Shoot / Rehearsal → Performance / Wrap`

**Looking For**
Photographers (headshots), Videographers (reel shoots), Acting Coaches, Stunt Coordinators
...
- Commission store manager (prints, patterns, tutorial PDFs, prop replicas)
- Fan meetup scheduler (autograph sessions at conventions)
- Costume stats editor (materials, build time, character origin, awards)
- "Currently building" public status announcement
...
- `/build-journal` — WIP blog (process photos, material notes, progress shots)
- `/conventions` — Upcoming appearances (dates, event name, booth, meetup times)
- `/store` — Commission store (prints, patterns, tutorial PDFs, prop replicas)
- `/commissions` — Custom commission inquiry with pricing tiers
- `/about` — Bio, cosplay origin, awards, social stats
...
- Commission price calculator (complexity tiers)
- Pattern PDF seller (upload and sell digital patterns instantly)
- Convention appearance planner (manage cons, booth numbers, autograph session times)
- Convention QR card (for con floors: "Find all my photos from this event")
- "Currently building" status widget (public announcement with % complete)
- Fan meetup scheduler (times and locations for meetups at conventions)
...
- Prop replica commissions
- Convention appearance fees (pro-level cosplayers)
- Brand ambassador deals
- Workshop / panel teaching at conventions
- Fan memberships / exclusive content
- Tips and Stars

**CRM Pipeline**
`Commission Inquiry → Quote → Deposit → Build → Progress Photos → Final Delivery → Invoiced`

**Looking For**
Photographers (costume photography specialty), Videographers, MUAs (SFX especially), Prop Makers, Other Cosplayers (group cosplay)
...
- Kit / product brand list
- Training & certification timeline
- Trial session scheduler (separate booking type for bridal trials)
- Bridal party package calculator (input party size → price + timing breakdown)
- Client skin profile tracker (skin type, concerns, allergies — private per client)
- Travel fee calculator (distance-based, auto-adds to quote)
...
- `/services` — Full service menu with pricing, duration, deposit info
- `/booking` — Appointment booking (on-location or studio, travel fee auto-calc)
- `/about` — Bio, training, certifications, brands used
- `/products` — Recommended products with affiliate links
...
- Bridal package calculator (party size → auto-calculates cost and schedule)
- Travel fee calculator (client address → auto-adds fee to quote)
- Client skin profile per client (private — skin type, tone, concerns, allergies)
- Affiliate link manager for beauty products (Sephora, MAC, Charlotte Tilbury, etc.)
- Training timeline display
...
- Online tutorial video sales

**CRM Pipeline**
`Inquiry → Consultation → Trial (bridal) → Booking Confirmed → Appointment → Invoiced`

**Looking For**
Photographers, Hair Stylists, Models, Fashion Designers, Other MUAs (large productions)
...
- Bridal trial and day-of as separate appointment types
- Product affiliate link manager
...
- `/services` — Full service menu with pricing and duration
- `/booking` — Appointment booking calendar
- `/about` — Bio, education, certifications, brands used
- `/products` — Recommended products with affiliate links
- `/contact` — General inquiry
...
- Bridal trial + day-of as separate bookable appointment types
- Education timeline (Vidal Sassoon, Aveda, Wella certifications)
...
**CRM Pipeline**
`Inquiry → Consultation → Trial (bridal) → Appointment → Follow-up / Re-book`

**Looking For**
Photographers, MUAs, Models, Fashion Designers
...
- Press / tearsheet clip manager (media mentions)
- Wholesale / retailer inquiry manager
- Custom order request manager
- Size chart builder per garment type
- Collaboration tracker (models, photographers, MUAs per collection shoot)
...
- `/shop` — Pattern downloads / digital products / physical items
- `/wholesale` — Wholesale info + inquiry form + retailer requirements
- `/press` — Press mentions, tearsheets, publication features
- `/about` — Brand story, design philosophy, materials focus, sustainability
- `/stockists` — Retailer list with links and interactive map
...
- Size chart builder per garment type
- Wholesale price calculator (retail → wholesale → keystone → MSRP)
- Press clip uploader (scan / upload tearsheets and publication features)
- Stockist map (approved retailers on interactive map)
- Custom order intake form (measurements, fabric preferences, timeline, budget)
- Production credit manager (credit model, photographer, MUA per lookbook shoot)
...
- Collaboration / licensing fees
- Workshop / sewing class teaching

**CRM Pipeline**
`Design Inquiry → Quote → Custom Order Contract → Production → Fitting → Final Delivery → Invoiced`

**Looking For**
Models, Photographers, Videographers, MUAs, Hair Stylists, Seamstresses, Retailers
...
- Waitlist manager with public booking status display
- Custom quote request inbox
- Convention / guest spot calendar
...
- `/booking` — Appointment booking with deposit (style / size / placement)
- `/healed` — Healed work gallery (tattoos 6–8 weeks post-healing)
- `/about` — Bio, style, shop info, certifications, conventions attended
- `/aftercare` — Public aftercare instructions (shareable link sent post-appointment)
- `/conventions` — Upcoming guest spots and convention appearances
...
- Deposit management (enforced at booking per appointment type)
- Waitlist manager with public "booking X months out" status display
- Custom quote request form (placement / size / style / reference photos / budget)
- Convention / guest spot calendar
- Aftercare page builder (auto-sent link to clients after appointment confirmation)
...
- Convention bookings
- Merchandise (prints of flash art, apparel)
- Educational content / tutorial sales

**CRM Pipeline**
`Custom Inquiry → Consult / Quote → Deposit → Appointment → Touch-up (if needed) → Invoiced`

**Looking For**
Photographers (portfolio shots), Models (showcase work), Other Tattoo Artists (guest spots / conventions)
...
- Model management (track models worked with)
- Event suitability and family-friendly tagging
...
- `/process` — Behind-the-scenes time-lapses, in-progress photos
- `/services` — Service types + pricing + duration display
- `/collab` — Open photography and videography collaborations
- `/about` — Bio, background, body-safe materials commitment
...
- Body-safe materials declaration (public — builds client trust)
- Event suitability tags (family-friendly / adult / festival / corporate / theatrical)
...
- Workshop / masterclass teaching
- Fine art body painting commissions

**CRM Pipeline**
`Inquiry → Concept Discussion → Quote → Contract → Model Confirmation → Paint Day → Gallery Delivery → Invoiced`

**Looking For**
Photographers (always — every body paint needs a photographer), Videographers, Models, Event Producers, Festival Organizers
...
- Performance package manager (format + duration + price)
- Venue suitability tagger
- Prop and fuel type list
- Troupe member manager (if part of a fire company)
...
- `/packages` — Performance packages (walkabout / short set / full show / workshop / festival)
- `/rider` — Technical rider page + downloadable PDF for venues
- `/safety` — Safety certifications, insurance info, fire safety protocol
- `/workshops` — Book a fire spinning workshop or class
- `/gallery` — Performance photo gallery (fire photography stills)
- `/about` — Bio, props mastered, years performing, notable shows
...
- Performance package builder (format / duration / price per package)
- Fuel type and safety measures display
- Venue compatibility checker (indoor/outdoor, ceiling height, sprinkler systems)
- Fire photography TFP board (connect specifically with photographers wanting fire shoot collabs)
- Workshop booking with integrated safety waiver
...
- TFP content licensing

**CRM Pipeline**
`Inquiry → Quote (event type + duration) → Technical Rider Sent → Contract → Deposit → Pre-show Safety Check → Show Day → Invoiced`

**Looking For**
Photographers (fire photography specialty), Videographers, Other Fire / Flow Artists (troupe work), Event Producers, Festival Organizers, Venues

---

## 🎪 Circus Performer

*Includes: Juggler, Acrobat, Aerialist, Contortionist, Tightrope Walker, Unicyclist, Stilt Walker, Human Statue, Clown, Escape Artist, Equilibrist, Sideshow Performer*
...
- Apparatus catalog (type, dimensions, weight, rigging requirements)
- Act structure builder (opening / build / climax / finale)
- Performance package manager
- Audience participation flag (which acts involve audience volunteers)
...
- `/packages` — Performance packages by format and duration
- `/rider` — Technical rider + rigging specs (aerialists) — downloadable PDF
- `/safety` — Certifications (SPRAT, rigging, insurance) displayed as badges
- `/workshops` — Book a workshop / class in their discipline
- `/gallery` — Performance photo gallery
- `/about` — Bio, training background, performance history
...
- Act duration options (5 / 10 / 20 / full show)
...
**CRM Pipeline**
`Inquiry → Quote → Rigging Specs Sent (aerialists) → Contract → Deposit → Venue Walkthrough → Show Day → Invoiced`

**Looking For**
Photographers (circus photography is spectacular), Videographers, Other Circus Performers (multi-act shows), Event Producers, Festival Organizers

---

## 💃 Dancer

*Includes: Ballet, Contemporary, Hip-hop, Ballroom/Latin, Pole Artist, Belly Dancer, Burlesque, Flamenco, Irish/Folk, Go-go, and all other styles*
...
- Class / workshop booking and schedule manager
- Competition record tracker
- Training timeline display
- Company / residency affiliation display
...
- `/about` — Training background, companies worked with, competition record
- `/classes` — Class and workshop schedule + booking
- `/choreography-hire` — Hire them to choreograph for your project
- `/residencies` — Current and past company / residency affiliations
...
- Class schedule manager (recurring weekly classes + one-off workshops with booking)
- Competition record tracker (competition name / year / placement / adjudicators)
- Training timeline (schools, companies, notable teachers)
- Residency display (current and past company affiliations)
...
**CRM Pipeline**
`Audition / Inquiry → Contract Offer → Contract → Rehearsal Period → Performance Run → Archived`

**Looking For**
Photographers, Videographers, Musicians (original scores / live music), Other Dancers (duets / group work)
...
- Set list manager per show type and venue size
- Merch store
- Band member roster (each member links to their individual creator profile)
- Technical rider builder (stage plot, backline, monitor needs, PA requirements)
- Streaming platform links hub (Spotify, Apple Music, Bandcamp, etc.)
- Venue history log (builds credibility display)
- Press quote manager
...
- `/about` — Bio, band members (linked to their creator profiles), origin story
- `/press` — EPK, press quotes, publications, downloadable media photos
- `/merch` — Merchandise store
- `/booking` — Booking inquiry (event type / capacity / date)
- `/rider` — Technical rider and stage plot (downloadable PDF)
- `/videos` — Music video gallery
...
- Technical rider PDF builder (backline / PA / monitor / hospitality requirements)
- Set list builder (organize songs into sets by show type and venue size)
- Band member roster (each member links to their own creator profile)
- Venue history display (past performance credits — builds credibility)
- Streaming platform hub (all links in one place)
- Music video gallery
- Lyrics page per track (toggle visible / hidden)
...
- Music licensing (sync, commercial)
- Fan patron memberships

**CRM Pipeline**
`Booking Inquiry → Availability Check → Quote → Contract → Technical Rider Sent → Day-of Logistics → Show → Invoiced`

**Looking For**
Photographers (live show + promo shots), Videographers (music videos), Sound Engineers, Venues, Other Musicians (collabs, features)
...
- Genre / BPM profile
- Equipment manager (what they bring, what venues must provide)
- Past events / venues log
...
- `/about` — Bio, genre specialties, residencies, festival credits
- `/booking` — Event booking with event type selector
- `/rider` — Technical rider (downloadable PDF)
...
- Equipment list (CDJs / controller / mixer / headphones — what they bring)
- Technical rider PDF for venues
- Residency display (current / past club residencies)
...
- Mix commissions and exclusive sets

**CRM Pipeline**
`Booking Inquiry → Quote → Contract → Technical Rider Sent → Event → Invoiced`

**Looking For**
Photographers / Videographers (event content), Venues, Event Producers, Promoters
...
- Content rating per act (clean / PG-13 / adult)
- Show credit log (venues, TV appearances, podcast features)
- Booking type manager (corporate / club / private / festival / college)
...
- `/about` — Bio, comedy style description, TV / podcast credits
- `/booking` — Book for your event (type + duration selector)
- `/press` — Press quotes, media features, downloadable press photos
- `/contact` — Booking inquiry
...
- Show credit list (notable venues, TV, podcasts, festival credits)
- Corporate vs. club rate card (displayed separately — different pricing contexts)
...
- Merchandise
- Workshop / comedy class teaching

**CRM Pipeline**
`Booking Inquiry → Set Length + Content Rating Confirmed → Quote → Contract → Show Logistics → Show → Invoiced`

**Looking For**
Photographers (promo shots), Videographers (specials / promo videos), Venues, Other Comedians (shows / touring)
...
- Audience size compatibility range per show type
- Family-friendly flag per act
...
- `/close-up` — Close-up / walkabout / table magic
- `/childrens` — Children's show (family-safe content)
- `/about` — Bio, career highlights, notable clients, TV appearances
- `/showreel` — Full reel with show type timestamps
- `/rider` — Technical requirements per show type (downloadable PDF)
- `/booking` — Book with show type + audience size selector
- `/contact` — General inquiry
...
- Technical requirements auto-selector (correct rider auto-generates per act type booked)
- Notable client display (with permission — huge corporate credibility marker)
...
**CRM Pipeline**
`Inquiry → Show Type + Audience Size Confirmed → Tech Requirements Sent → Quote → Contract → Venue Logistics → Show → Invoiced`
...
- Rate card by project type and usage rights
- Audition submission tracker
...
- `/demos` — Demo reel by category:
  ...
  - Animation / Characters (multiple voices)
  - Narration / Corporate
  - Audiobook (long-form reads)
  - Video Game / Interactive
  - Promo / Trailer
  - E-learning / Explainer
- `/about` — Bio, coaching background, union status, home studio specs
- `/rates` — Rate card by project type + usage (broadcast / web / internal / podcast)
- `/clients` — Notable client / project list
...
- Rate card builder by usage type (broadcast / web / internal — different rates are industry standard)
- Union status badge (SAG-AFTRA / non-union / Fi-Core)
- Audition tracker (project / casting director / date / callback status)
...
**CRM Pipeline**
`Audition → Callback → Session Booked → Session Day → Pick-ups / Edits → Delivered → Invoiced`

**Looking For**
Recording Studios, Sound Engineers, Directors, Casting Directors

---

## ✍️ Spoken Word Artist / Slam Poet
...
- Workshop / masterclass booking manager
- Commission intake form (write a custom poem for someone)
...
- `/shows` — Upcoming events, slams, readings, festivals
- `/workshops` — Workshop / masterclass booking
- `/commissions` — Commission a custom poem (occasion / style / budget / deadline)
- `/about` — Bio, slam circuit experience, publications, awards
- `/contact` — Booking inquiry
...
- Commission intake form (occasion / theme / style / word count / deadline)
- Slam circuit record display (teams, competitions, venues performed at)
...
- Custom poem commissions
- Residency / artist-in-residence fees

**CRM Pipeline**
`Booking Inquiry → Quote → Confirmed → Pre-show Details → Performance → Invoiced`

**Looking For**
Musicians (musical poetry / spoken word + music collaborations), Photographers, Videographers, Other Poets (group shows / slams)
...
- Physical stats profile (critical for double matching)
- Insurance / clearance display
...
- `/resume` — Credits (film / TV / commercial / stunt double credits)
- `/about` — Bio, training, union status, physical stats for matching
...
- Consulting for productions

**CRM Pipeline**
`Coordinator Contact → Availability Check → Contract → Shoot Day(s) → Wrap → Invoiced`

**Looking For**
Stunt Coordinators, Photographers (action / portfolio shots), Videographers, Fight Choreographers

---

## 🤼 Pro Wrestler / Lucha Libre
...
- Match clip library
- Signature and finisher move showcase clips
...
- `/championships` — Championship history timeline with belt photos
- `/appearances` — Fan meet & greet events, signing sessions, convention panels
- `/merch` — Fan merchandise (shirts, masks, action figures, signed photos)
...
- Finisher and signature move showcase (dedicated highlight clips)
- Promotion affiliation badges (verified promotion logos)
...
**CRM Pipeline**
`Booking Inquiry → Confirmation → Logistics → Show / Appearance → Invoiced`

**Looking For**
Photographers (character / action shots), Videographers (match footage, promos), Event Producers

---

## 🤸 Parkour / Freerunning Artist
...
- Commercial / stunt work portfolio (separate from art movement)
- Discipline tags
...
- `/workshops` — Beginner / intermediate / advanced workshop booking
- `/commercial` — Commercial and brand work portfolio (separate section)
...
- Online tutorial sales

**CRM Pipeline**
`Booking Inquiry → Discipline + Level Confirmed → Quote → Contract → Session → Invoiced`

**Looking For**
Videographers (critical — they need great video content), Photographers, Brands, Film Directors, Stunt Coordinators
...
- Shared portfolio manager (collective work across all photographers)
- Collective revenue dashboard (studio-wide view)
...
- `/studio-rental` — Book the physical space (calendar, pricing, what is included, floor plan)
- `/equipment` — Equipment rental list (cameras, lights, backdrops, props, grip)
- `/about` — Studio story, location, amenities, parking info
- `/booking` — Book a photographer OR book the studio space (two distinct booking flows)
- `/contact` — General inquiry
...
- Team availability matrix (see which photographers are free on any given date)
- Collective analytics dashboard (studio-wide bookings, revenue, space utilization)
...
- Workshop / class hosting (rent the space for a photography class)
- Event photography packages (entire studio team for large events)

**CRM Pipeline**
`Inquiry → Team / Space Availability Check → Proposal → Deposit → Shoot Day → Gallery Delivery → Invoice → Archived`

**Looking For**
Models, MUAs, Hair Stylists, Fashion Designers, Individual Photographers (to join studio roster)
...
- Agent assignment (which agent manages which talent)
- Agency-wide availability calendar (across all represented talent)
- Talent submission intake manager (applications from unsigned talent)
...
- `/about` — Agency history, specialties, markets served, agent team
- `/submit` — Talent submission form (unsigned talent apply for representation)
...
- Talent submission intake form (for unrepresented talent applying to the agency)
- Agency contract template manager (standard representation agreements)
...
**CRM Pipeline**
`Booking Request → Talent Match → Availability Check → Quote → Contract → Talent Confirmed → Project / Show → Commission Collected`

**Looking For**
All creator types for roster expansion, Event Producers, Brand Clients, Casting Directors

---

## 🎪 Performance Troupe / Company / Band (Group Profiles)
...
- Group technical rider (combines individual riders into one group document)
- Revenue split manager (how fees divide among members — % per person)
...
- `/performances` — Group showreel and past performance gallery
- `/packages` — Group performance packages (what they offer as a unit, priced)
- `/rider` — Group technical rider (downloadable PDF)
- `/booking` — Book the group (checks all member availability simultaneously)
- `/merch` — Group merchandise
- `/contact` — Booking inquiry
...
- Member spotlight rotation (feature a different member on group homepage each week)
- Group showreel editor (combine clips from individual member performance libraries)
...
- Sponsor / brand deals as a group entity

**CRM Pipeline**
`Booking Inquiry → All-Member Availability Check → Quote → Contract → Technical Rider Sent → Deposit → Show Day → Revenue Split Processed → Invoiced`

**Looking For**
Photographers, Videographers, Event Producers, Festival Organizers, Venues
...
| Model | — | ✅ | — | — | — | — | — | — |
| Actor | ✅ Demo reel | — | — | — | ✅ | ✅ Résumé | — | — |
| Cosplayer | — | — | — | ✅ Patterns/prints | ✅ Workshops | — | — | — |
| MUA | — | — | — | — | ✅ Masterclass | ✅ Certs | — | — |
| Hair Stylist | — | — | — | — | ✅ | ✅ Certs | — | — |
| Fashion Designer | — | — | — | ✅ Patterns | ✅ Sewing | — | — | — |
| Tattoo Artist | — | — | — | ✅ Flash | — | — | — | — |
| Body Painter | — | — | — | — | ✅ | — | ✅ Materials | — |
| Fire Performer | ✅ | — | ✅ | — | ✅ | — | ✅ Fire/Insurance | — |
| Circus Performer | ✅ | — | ✅ Rigging too | — | ✅ | — | ✅ Rigging/Certs | — |
| Dancer | ✅ | — | — | — | ✅ | ✅ Company | — | — |
| Musician / Band | ✅ + Audio | — | ✅ Stage plot | ✅ Merch | ✅ | ✅ Credits | — | ✅ Band |
| DJ | ✅ Mixes | — | ✅ | — | — | ✅ Venues | — | — |
| Comedian | ✅ Set clips | — | — | — | ✅ | ✅ TV/credits | — | — |
| Magician | ✅ per type | — | ✅ per show type | — | — | ✅ | — | — |
| Voice Actor | ✅ Audio | — | — | — | ✅ Coaching | ✅ Credits | — | — |
| Spoken Word | ✅ + Written | — | — | — | ✅ | ✅ Publications | — | — |
| Stunt Performer | ✅ | — | — | — | ✅ | ✅ | ✅ Insurance | — |
| Pro Wrestler | ✅ Match clips | — | — | ✅ Merch | — | ✅ | — | — |
| Parkour | ✅ | — | — | — | ✅ | — | — | — |
